...
void gemm_cublas_batched(
  ...
  CUBLAS_CHECK(cublasSgemmStridedBatched(handle.get(),
                                         CUBLAS_OP_N,
                                         CUBLAS_OP_N,
                                         N,
                                         M,
                                         ...
                                         B,
                                         N,
                                         static_cast<std::int64_t>(K) * N,  // B^T viewed as (N, K)
                                         A,
                                         K,
                                         static_cast<std::int64_t>(M) * K,  // A^T viewed as (K, M)
                                         &beta,
                                         C,
                                         N,
                                         static_cast<std::int64_t>(M) * N,  // C^T viewed as (N, M)
                                         batch));
}
